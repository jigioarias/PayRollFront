...
import { Filter, Nomina } from 'src/app/inventory/shared/master';
...
export class GenerateNominaService {
  ...
  generate(filter:Filter): Observable<Nomina[]> {
    const url = environment.apiUrl;

    return this.http.post<ResponseList<Nomina>>(`${url}generateClassPayRoll`,filter).pipe(
